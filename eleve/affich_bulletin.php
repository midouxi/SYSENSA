...
<?php
	...
	<form method="GET" name='affichbulletinELEVE'>
	<input type='hidden' value=<?php print("'".$trimestre."'"); ?> name='trimestre' >
	<input type='hidden' value=<?php print("'".$classe."'"); ?> name='classe'>
	...
	<br>
	<input type='button' value='0k' onclick="ahah('affich_bulletin.php?eleve='+document.forms.affichbulletinELEVE.eleve.value+'&classe='+document.forms.affichbulletinELEVE.classe.value+'&trimestre='+document.forms.affichbulletinELEVE.trimestre.value,'bulletin2');">
	</form>
	<?php
		...
		while($ligne=mysql_fetch_array($allclasse)){
				if($ligne['id_eleve'] == $id_eleve){
					if( $prec!=NULL){
						...
						<form name="affichbulletinELEVEPREC" method="GET">
						<input type='hidden' value=<?php print("'".$trimestre."'"); ?> name='trimestre' >
						<input type='hidden' value=<?php print("'".$classe."'"); ?> name='classe'>
						<input type='hidden' value=<?php print("'".$prec."'"); ?> name='eleve'>
						<input type='button' value="< eleve precedent" onclick="ahah('affich_bulletin.php?eleve='+document.forms.affichbulletinELEVEPREC.eleve.value+'&classe='+document.forms.affichbulletinELEVEPREC.classe.value+'&trimestre='+document.forms.affichbulletinELEVEPREC.trimestre.value,'bulletin2');">
						</FORM>
						<?php
						print("</td>");
					}
					...
					if(isset($suiv)){
						...
						<form name="affichbulletinELEVESUIV" method="GET">
						<input type='hidden' value=<?php print("'".$trimestre."'"); ?> name='trimestre' >
						<input type='hidden' value=<?php print("'".$classe."'"); ?> name='classe'>
						<input type='hidden' value=<?php print("'".$suiv[0]."'"); ?> name='eleve'>
						<input type='button' value="eleve suivant >" onclick="ahah('affich_bulletin.php?eleve='+document.forms.affichbulletinELEVESUIV.eleve.value+'&classe='+document.forms.affichbulletinELEVESUIV.classe.value+'&trimestre='+document.forms.affichbulletinELEVESUIV.trimestre.value,'bulletin2');">
						</FORM>
						<?php
						print("</td>");
					}else print("");					
